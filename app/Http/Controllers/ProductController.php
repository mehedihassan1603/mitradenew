...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($role->hasPermissionTo('products-add')){
            ...
            $hscodes = HSCode::where('status', true)->get();
            ...
            if(in_array('restaurant',explode(',',$general_setting->modules))){
                ...
                return view('backend.product.create',compact('kitchen_list', 'hscodes','menu_type_list','lims_product_list_without_variant', 'lims_product_list_with_variant', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list', 'lims_warehouse_list', 'numberOfProduct', 'custom_fields'));
            }

            return view('backend.product.create',compact('lims_product_list_without_variant', 'hscodes', 'lims_product_list_with_variant', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list', 'lims_warehouse_list', 'numberOfProduct', 'custom_fields'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
