                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="supplier_type" class="form-control">
                                        <option value="" disabled {{ is_null($lims_supplier_data->supplier_type) ? 'selected' : '' }}>-- {{ trans('Select Supplier Type') }} --</option>
                                        <option value="Supplier" {{ $lims_supplier_data->supplier_type == 'Supplier' ? 'selected' : '' }}>{{ trans('Supplier') }}</option>
                                        <option value="Exporter" {{ $lims_supplier_data->supplier_type == 'Exporter' ? 'selected' : '' }}>{{ trans('Exporter') }}</option>
                                        <option value="Door-to-Door" {{ $lims_supplier_data->supplier_type == 'Door-to-Door' ? 'selected' : '' }}>{{ trans('Door-to-Door') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
