...
<script type="text/javascript">
    ...
    tinymce.init({
  selector: 'textarea.form-control[name="note"]', // Select textarea with class="form-control" and name="note"
  height: 130,
  plugins: [
  ...
  branding: false,
  fontsize_formats: "7pt 8pt 9pt 10pt 12pt 14pt 18pt 24pt 36pt", // Specify available font sizes
  content_style: "body { font-size: 8px; }" // Set the default font size to 9pt
});
