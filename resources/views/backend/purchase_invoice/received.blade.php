                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="supplementary_duty" id="supplementary_duty" class="form-control">
                                </div>
                                <div class="col-md-4 mb-2">
                                    <label for="thc" class="form-label">Terminal Handling Charges</label>
                                    <input type="number" name="thc" id="thc" class="form-control">
                                </div>
                                <div class="col-md-4 mb-2">
                                    <label for="container_handling" class="form-label">Container Handling / Offloading</label>
                                    <input type="number" name="container_handling" id="container_handling" class="form-control">
                                </div>
                                <div class="col-md-4 mb-2">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="documentation_charges" id="documentation_charges" class="form-control">
                                </div>
                                <div class="col-md-4 mb-2">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="warehouse_receiving" id="warehouse_receiving" class="form-control">
                                </div>
                                <div class="col-md-4 mb-2">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="packaging_labeling" id="packaging_labeling" class="form-control">
                                </div>
                                <div class="col-md-4 mb-2">
