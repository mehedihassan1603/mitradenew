                        ...
                        {{-- Extra Input Fields --}}
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="custom_duty" id="custom_duty" class="form-control" step="0.01">
                                </div>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="supplementary_duty" id="supplementary_duty" class="form-control" step="0.01">
                                </div>
                                ...
                                <div class="col-md-4 mb-2">
                                    <label for="container_handling" class="form-label">Container Handling / Offloading</label>
                                    <input type="number" name="container_handling" id="container_handling" class="form-control" step="0.01">
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="custom_clearance" class="form-label">Custom Clearance Fees</label>
                                    <input type="number" name="custom_clearance" id="custom_clearance" class="form-control" step="0.01">
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="documentation_charges" class="form-label">Documentation Charges</label>
                                    <input type="number" name="documentation_charges" id="documentation_charges" class="form-control" step="0.01">
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="truck_cost" class="form-label">Truck / Carrier Cost</label>
                                    <input type="number" name="truck_cost" id="truck_cost" class="form-control" step="0.01">
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="warehouse_receiving" class="form-label">Warehouse Receiving Charges</label>
                                    <input type="number" name="warehouse_receiving" id="warehouse_receiving" class="form-control" step="0.01">
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="inspection_qc" class="form-label">Inspection / QC Charges</label>
                                    <input type="number" name="inspection_qc" id="inspection_qc" class="form-control" step="0.01">
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="packaging_labeling" class="form-label">Packaging / Labeling</label>
                                    <input type="number" name="packaging_labeling" id="packaging_labeling" class="form-control" step="0.01">
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="fuel_toll" class="form-label">Fuel Surcharge</label>
                                    <input type="number" name="fuel_toll" id="fuel_toll" class="form-control" step="0.01">
                                </div>
