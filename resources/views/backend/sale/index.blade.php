        ...
        <div class="modal-content">
            <div class="container mt-3 pb-2 border-bottom">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <h4 style="margin: 0;">{{ trans('file.Sale Details') }}</h4>
                    </div>
            ...
            <table class="table table-bordered product-sale-list">
                <thead>
                    ...
                    <th>{{trans('file.Actual Price')}}</th>
                    <th>{{trans('file.Discount')}}</th>
                    <th>{{trans('file.Discounted Rate')}}</th>
                    <th>{{trans('file.Total Taka')}}</th>
                </thead>
                <tbody>
                </tbody>
            </table>
...
<script type="text/javascript">
    ...
    function saleDetails(sale){
        console.log('Saleeeeeeeeeeeeeeee', sale);
        ...
        <td style="border: 0px solid black!important; padding: 0px !important;">
            <div style="display: flex; justify-content: space-between;">
                ...
                <div style="text-align: right;">
                   <strong>{{ trans("file.reference") }}:</strong> ${sale[1]}
                </div>
            </div>
        </td>
    </tr>
...
`;
        ...
        // if(sale[25])
            ...
            // htmltext += '<strong>{{trans("file.Attach Document")}}: </strong><a href="documents/sale/'+sale[25]+'">Download</a><br>';
...
`;
        ...
        $.get('sales/product_sale/' + sale[13], function(data){
            ...
            var attribute1 = data[11];
            var attribute2 = data[12];
            var attribute3 = data[13];
            var attribute4 = data[14];
            var attribute5 = data[15];
            var attribute6 = data[16];
            var unit_price = data[17];
            var net_unit_price = data[18];
            var unit_discount = data[19];
            var product_model = data[20];
    ...
    cols += '</td>'; // Close <td>
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong>{{trans("file.Other Discount")}}:</strong></td>';
            cols += '<td>' + sale[19] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            if(sale[28]) {
            ...
            var discount = parseFloat(sale[19]) + parseFloat(sale[15]);
var newRow = $("<tr>");
var cols = '';
cols += '<td colspan=7><strong>{{ trans("Total Discount") }}:</strong></td>';
cols += '<td>' + discount + '</td>';
newRow.append(cols);
newBody.append(newRow);
