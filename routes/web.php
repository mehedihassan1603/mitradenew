...
use App\Http\Controllers\ForeignQuotationController;
...
Route::get('/model-create', [HomeController::class, 'modelCreate'])->name('model.create');
...
// Route::get('model/create', [ProductController::class, 'modelCreate'])->name('model.create');
// Route::post('model/store', [ProductController::class, 'modelStore'])->name('model.store');
// Route::delete('model/delete/{id}', [ProductController::class, 'modelDelete'])->name('model.delete');
// Route::get('model/edit/{id}', [ProductController::class, 'modelEdit'])->name('model.edit');
// Route::post('model/update/{id}', [ProductController::class, 'modelUpdate'])->name('model.update');
...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
    ...
    Route::get('/purchase-requisition/list',[\App\Http\Controllers\PurchaseRequisitionController::class,'index'])->name('purchase.requisition.index');
...
//     ->name('request.quotation.compare');
 Route::get('compare/{requisition}', [RequestQuotationController::class, 'compare'])->name('foreign-quotations.compare');
    // Route::post('approve/{id}', [ForeignQuotationController::class, 'approve'])->name('request-quotations.approve');
    Route::post('/quotation/{id}/approve', [QuotationController::class, 'approveQuotation'])->name('quotation.approve');
    // routes/web.php
// routes/web.php
...
Route::post('purchase-invoice-received/{id}/approve', [InvoiceReceivedController::class, 'approve'])
    ->name('purchase.invoice.received.approve');

    Route::get('purchase-invoice-received/{id}', [InvoiceReceivedController::class, 'show'])->name('purchase.invoice.received.show');
// Route::post('purchase-invoice-received/{id}/approve', [PurchaseInvoiceReceivedController::class, 'approve'])->name('purchase.invoice.received.approve');
...
Route::get('purchase-invoice-received', [\App\Http\Controllers\InvoiceReceivedController::class, 'index'])
    ->name('purchase.invoice.received.index');
    ...
    Route::get('/hs-code-list',[\App\Http\Controllers\HSCodeController::class,'index'])->name('hs.code.list');
    Route::post('/hs-code-store',[\App\Http\Controllers\HSCodeController::class,'store'])->name('hs.code.store');
    Route::get('/hs-code-edit',[\App\Http\Controllers\HSCodeController::class,'edit'])->name('hs.code.edit');


    Route::get('/purchase-requisition-list',[\App\Http\Controllers\PurchaseRequisitionController::class,'index'])->name('purchase.requisition.list');
    Route::get('/purchase-requisition-create',[\App\Http\Controllers\PurchaseRequisitionController::class,'create'])->name('purchase.requisition.create');
    ...
    Route::controller(AdjustmentController::class)->group(function () {
        ...
        Route::delete('model/delete/{id}',  'modelDelete')->name('model.delete');
        Route::get('model/edit/{id}',  'modelEdit')->name('model.edit');
        Route::post('model/update/{id}', 'modelUpdate')->name('model.update');
    });
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::prefix('report')->group(function () {
            ...
            Route::post('supplier-ledger-data', 'supplierLedgerData');
